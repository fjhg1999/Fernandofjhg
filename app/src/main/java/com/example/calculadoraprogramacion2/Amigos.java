...
public class Amigos extends SQLiteOpenHelper {
    ...
    private static final String SQLdb = "CREATE TABLE amigos (idAmigo int primary key autoincrement, nombre text, direccion text, telefono text, " +
            "email text, dui text)";
    public Amigos(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
